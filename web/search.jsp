  ...
  <div class="container">
    <div class="register">
      <div class="col-md-6 login-right">
        ...
        <p>We provide you the best searching engine which makes you find your product as fast as possible.</p>
        <form method="post" action="SearchClothes">
          <input type="hidden" name="action" value="load" />

          <div>
            <span>Name's Product<label>*</label></span>
            <input type="text" name="txtname" size="10" />
          </div>
          <div>
            <span>Clothes's Brand<label>*</label></span>
          <%
...
//Class.forName("com.mysql.jdbc.Driver").newInstance();
          ...
          <div>
            <span>Range of Price<label>*</label></span>
            <select name="txtprice">
