        ...
        <div class="col-lg-12">
          <%
            ...
            try {
              ...
              ResultSet rs = stmt.executeQuery("select * from receiptdetail ");
              while (rs.next()) {
                int id = rs.getInt("id");
int product=rs.getInt("p_id");
                String name = rs.getString("name");
                int quantity=rs.getInt("quantity");
                float total=rs.getFloat("total");
                int price = rs.getInt("price");
                Recipe cat = new Recipe(id,product,name,price,quantity,total);
                list.add(cat);
              }
          ...
          %>
            ...
            <table class="table-fill">
              ...
              <tr>
                ...
                <td class="text-left">${c.p_id}</td>
                <td class="text-left">${c.name}</td>
                  <td class="text-left">${c.quantity}</td>
