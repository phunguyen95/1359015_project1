...
<div class="container">
  <div class="women_main">
    <div class="col-md-9 w_content">
      ...
      <!-- grids_of_4 -->
      <c:forEach var="cloth" items="${trend}">
    ...
    <%--For displaying Previous link except for the 1st page --%>
      <c:if test="${currentPage != 1}">
        <!--  <td> --><a href="GetIdBrand?name=<%=session.getAttribute("i")%>&d=${currentPage - 1}">&nbsp;Previous</a><!-- </td> -->
      </c:if>
      ...
      <c:forEach begin="1" end="${noOfPages}" var="i">
        <c:choose>
          ...
          <c:otherwise>
            <!--  <td> --><a href="GetIdBrand?name=<%=session.getAttribute("i")%>&d=${i}">${i}&nbsp;</a><!-- </td> -->
          </c:otherwise>
        </c:choose>
      </c:forEach><!--  </tr> -->
      ...
      <c:if test="${currentPage lt noOfPages}">
        <!--  <td> --><a href="GetIdBrand?name=<%=session.getAttribute("i")%>&d=${currentPage + 1}">&nbsp;Next</a><!-- </td> -->
      </c:if>
    </div>
    <!-- end grids_of_4 -->
  </div>
