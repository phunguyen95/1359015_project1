...
<div class="header_bottom men_border">
  <div class="container">
    ...
    <div class="col-xs-3 header-bottom-right">
      ...
      <div class="search">
        <form method="most" action="Search">
  ...
  <div class="women_main">
    <div class="col-md-9 w_content">
      ...
      <c:if test="${not empty search}">
        <h3>There are ${search.size()} products was founded each page</h3>
      </c:if>
      <c:if test="${empty search}">
        <h3>There are no record was founded</h3>
      </c:if>
      <c:forEach var="cloth" items="${search}">
        ...
        <div class="grid1_of_4">
          <div class="content_box"><a href="GetId?name=${cloth.id}">
            ...
            <h5 style="font-size: 13px"><a href="GetId?name=${cloth.id}"> ${cloth.name}</a></h5>
              ${cloth.price}$
          </div>
        </div>
      ...
      <c:if test="${currentPage != 1}">
        <!--  <td> --><a href="Search?name=<%=session.getAttribute("i")%>&d=${currentPage - 1}">&nbsp;Previous</a><!-- </td> -->
      </c:if>
      ...
      <c:forEach begin="1" end="${noOfPages}" var="i">
        <c:choose>
          ...
          <c:otherwise>
            <!--  <td> --><a href="Search?name=<%=session.getAttribute("i")%>&d=${i}">${i}&nbsp;</a><!-- </td> -->
          </c:otherwise>
        </c:choose>
      </c:forEach><!--  </tr> -->
      ...
      <c:if test="${currentPage lt noOfPages}">
        <!--  <td> --><a href="Search?name=<%=session.getAttribute("i")%>&d=${currentPage + 1}">&nbsp;Next</a><!-- </td> -->
      </c:if>
    </div>
    <!-- end grids_of_4 -->
  </div>
