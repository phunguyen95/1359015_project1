...
<%
  List<ClothesCart> list = new ArrayList<ClothesCart>();
  try {
  ...
  try {
    ...
    while (rs.next()) {
      ...
      ClothesCart cat=new ClothesCart(id,name,picture,price);
      list.add(cat);
    }
    session.setAttribute("mostbuy",list);
    request.setAttribute("mostbuy", list);
        ...
        <div class="container">
          <div class="women_main">
            <div class="col-md-9 w_content">
              ...
              <h3>Top 9 Most Buy</h3>

              <!-- grids_of_4 -->
              <c:forEach var="cloth" items="${mostbuy}">
