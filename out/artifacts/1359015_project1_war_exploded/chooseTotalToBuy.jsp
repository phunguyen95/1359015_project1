...
<div id="wrap">
  ...
  <div id="accordian">
    ...
    <div class="content" id="address">
      <form action="FileUpload" class="go-right" action="FileUpload" method="post">
...
<div class="left" id="ordered">
  ...
  <div class="products">
          ...
          <div class="product_details">
            <span class="product_name">${c.name}</span>
            <span class="quantity">${c.total}</span>
      ...
      <div class="right" id="reviewed">
        <div class="billing">
          ...
          <div class="address_reviewed">
            ...
            <span class="phone"><%=session.getAttribute("telehone")%></span>
          </div>
        </div>
        <div class="shipping">
        ...
        <div id="complete">
          <a class="big_button"  href="#">Complete Order</a>
